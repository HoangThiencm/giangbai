...
- Bổ sung thanh tiến trình, thông báo trạng thái, sao chép Markdown, xuất `.doc` chứa OMML và tùy chọn `.docx`.
...
- Kiểm tra tĩnh: không còn tham chiếu `authToken`, `access-control.js` hay nút/luồng sao chép prompt cũ.
