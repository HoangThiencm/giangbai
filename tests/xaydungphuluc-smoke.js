...
assert(sliderInteraction.aiFifty.includes('tối đa'),'AI slider label must retain its maximum-period guidance after picker rendering');
...
assert(sliderInteraction.aiCount<=sliderInteraction.aiLimit,'AI slider selection must respect its period cap');
