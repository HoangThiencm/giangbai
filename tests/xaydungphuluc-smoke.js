...
const file=path.join(__dirname,'..','GIAO AN','XAYDUNGPHULUC','xaydungphuluc.html');
...
['khbd_gemini_api_keys','gemini_api_keys','xdpl_gemini_api_keys','loadKeys','saveKeys','checkKeys','429','403'].forEach(has);
