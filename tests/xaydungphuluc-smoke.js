...
['saveDraftToServer','loadDraftFromServer','buildDraftPayload','applyDraftPayload','openSaveDraftModal','openLoadDraftModal','fetchAndRenderDraftList','buildDraftSummary','loadDraftById','deleteDraftFromServer','api/user_phuluc_draft.php','💾 Lưu lên CSDL','📂 Tải từ CSDL','id="draftStatus"','id="saveDraftModal"','id="loadDraftModal"','id="draftTitleInput"','id="draftListContainer"','aiSelectedLessonIds','nlsSelectedLessonIds','sgkCompactContext','sgkKnowledgeBase','Gợi ý NLS theo tỉ trọng','Tích hợp NLS (CV 3456)'].forEach(has);
