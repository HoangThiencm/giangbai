...
for (const targetPath of targetPaths) {
  ...
  assert.ok(targetHtml.includes('20260916-canvas-module-v8'), `${relPath} phải cache-bust bản Canvas module v8`);
  ...
  assert.ok(targetHtml.includes('v=20260916-canvas-module-v8'), `${relPath} phải cache-bust khbd-app bản Canvas module v8`);
