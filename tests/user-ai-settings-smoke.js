...
assert.match(settings, /userAiGeminiModelCustom/, "primary model supports manual input");
assert.match(settings, /userAiGeminiFallbackModel/, "dropdown fallback Gemini");
assert.match(settings, /userAiGeminiFallbackModelCustom/, "fallback model supports manual input");
...
assert.match(settings, /currentFallbackModel/, "có helper đọc fallback model");
assert.match(settings, /persistFallbackModel/, "có helper lưu fallback model");
assert.match(settings, /default_gemini_fallback/, "lưu default_gemini_fallback");
assert.match(settings, /khbd_gemini_fallback_model/, "đồng bộ khbd_gemini_fallback_model");
assert.match(settings, /__custom__/, "dropdown có tùy chọn tự nhập model");
...
assert.match(settings, /gemini-2\.0-flash-thinking-exp-01-21/, "dropdown có model gợi ý mới");
