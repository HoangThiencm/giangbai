...
assert.ok(subjectIds.includes('lichsu') && subjectIds.includes('diali') && subjectIds.includes('lichsudialy'));
assert.ok(subjectIds.includes('vatli') && subjectIds.includes('hoahoc') && subjectIds.includes('sinhhoc'));
...
assert.ok(countItems(getLessonsForBook('vatli', 'x', 6)) > 5, 'vatli 6');
assert.ok(countItems(getLessonsForBook('hoahoc', 'x', 6)) > 5, 'hoahoc 6');
assert.ok(countItems(getLessonsForBook('sinhhoc', 'x', 6)) > 5, 'sinhhoc 6');
assert.ok(countItems(getLessonsForBook('vatli', 'x', 7)) > 5, 'vatli 7');
assert.ok(countItems(getLessonsForBook('hoahoc', 'x', 7)) > 5, 'hoahoc 7');
assert.ok(countItems(getLessonsForBook('sinhhoc', 'x', 7)) > 5, 'sinhhoc 7');
assert.ok(countItems(getLessonsForBook('vatli', 'x', 8)) > 5, 'vatli 8');
assert.ok(countItems(getLessonsForBook('hoahoc', 'x', 8)) > 5, 'hoahoc 8');
assert.ok(countItems(getLessonsForBook('sinhhoc', 'x', 8)) > 5, 'sinhhoc 8');
assert.ok(countItems(getLessonsForBook('vatli', 'x', 9)) > 5, 'vatli 9');
assert.ok(countItems(getLessonsForBook('hoahoc', 'x', 9)) > 5, 'hoahoc 9');
assert.ok(countItems(getLessonsForBook('sinhhoc', 'x', 9)) > 5, 'sinhhoc 9');
...
assert.ok(countItems(getLessonsForBook('lichsu', 'x', 6)) > 5, 'lichsu 6');
assert.ok(countItems(getLessonsForBook('diali', 'x', 6)) > 5, 'diali 6');
assert.ok(countItems(getLessonsForBook('lichsu', 'x', 7)) > 5, 'lichsu 7');
assert.ok(countItems(getLessonsForBook('diali', 'x', 7)) > 5, 'diali 7');
assert.ok(countItems(getLessonsForBook('lichsu', 'x', 8)) > 5, 'lichsu 8');
assert.ok(countItems(getLessonsForBook('diali', 'x', 8)) > 5, 'diali 8');
assert.ok(countItems(getLessonsForBook('lichsu', 'x', 9)) > 5, 'lichsu 9');
assert.ok(countItems(getLessonsForBook('diali', 'x', 9)) > 5, 'diali 9');
