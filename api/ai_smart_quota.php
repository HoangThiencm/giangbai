...
function ai_smart_quota_status(?array $cfg = null): array
{
    ...
    if (!$cfg['enabled']) {
        return [
            ...
            'remaining_pct' => 100.0,
            'used_pct' => $usedPct,
            'message' => 'Smart Quota đang tắt — không theo dõi quota Cloudflare; DS2API vẫn đứng trước Cloudflare nếu đang bật.',
            'teacher_notice' => '',
            'student_notice' => '',
    ...
    return [
        ...
        'message' => $teacherNotice !== '' ? $teacherNotice : 'Quota Cloudflare ổn định — Worker chỉ là tầng dự phòng sau DS2API.',
