...
function page_catalog(): array
{
    return [
        ...
        'soankhbd' => ['title' => 'Soạn Kế hoạch Bài dạy AI (KHBD)', 'url' => 'soankhbd.html'],
        'taovideo' => ['title' => 'Tạo video bài giảng', 'url' => 'taovideo/index.html'],
        ...
        'sodiem' => ['title' => 'Sổ điểm & KTTX', 'url' => 'sodiem.html'],
        ...
        'taobaitap' => ['title' => 'Tạo bài tập', 'url' => 'https://gemini.google.com/app/60fb4374a4209a92?hl=vi'],
