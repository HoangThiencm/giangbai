...
// 8 hình vẽ toán học được VẼ LẠI CHUẨN VECTOR SVG / PNG chất lượng cao
const illustrations = [
  {
    id: 'hinh-3.1',
    dataUrl: getImgDataUrl(path.join(__dirname, 'hinh_ve_sgk/hinh_3_1.png')),
    caption: 'Hình 3.1: Hoạt động mở đầu — Ghép 4 tứ giác giấy quanh một điểm chung',
    width: 380,
    height: 197
  },
  {
    ...
    caption: 'Hình 3.2: Các hình tứ giác (a, b, c) và không phải tứ giác (d)',
    width: 440,
    height: 149
  },
  {
    ...
    caption: 'Hình 3.4: Tứ giác ABCD và hai đường chéo cắt nhau',
    width: 290,
    height: 201
  },
  {
    ...
    caption: 'Hình 3.5: Kẻ đường chéo BD chia tứ giác thành hai tam giác',
    width: 320,
    height: 194
  },
  {
    ...
    caption: 'Hình 3.6: Ví dụ tính góc D của tứ giác ABCD',
    width: 260,
    height: 203
  },
  {
    ...
    caption: 'Hình 3.7: Luyện tập 2 — Tính góc F của tứ giác EFGH',
    width: 260,
    height: 203
  },
  {
    ...
    caption: 'Hình 3.8: Bài tập 3.1 — Tính góc chưa biết của các tứ giác',
    width: 410,
    height: 189
  },
  {
    ...
    caption: 'Hình 3.10: Bài tập 3.3 — Tứ giác ABCD hình "cái diều"',
    width: 280,
    height: 210
  }
];
