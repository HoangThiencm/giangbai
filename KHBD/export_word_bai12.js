...
// 11 hình vẽ toán học Bài 12 được VẼ LẠI CHUẨN VECTOR SVG / PNG (thuần hình học, sạch sẽ, không thừa caption)
const illustrations = [
  {
    id: 'hinh-3.27',
    dataUrl: getImgDataUrl(path.join(__dirname, 'hinh_ve_sgk/hinh_3_27.png')),
    width: 430,
    height: 231
  },
  {
    id: 'hinh-geogebra-bai12',
    dataUrl: getImgDataUrl(path.join(__dirname, 'hinh_ve_sgk/hinh_geogebra_bai12.png')),
    width: 470,
    height: 204
  },
  {
    id: 'hinh-3.28',
    dataUrl: getImgDataUrl(path.join(__dirname, 'hinh_ve_sgk/hinh_3_28.png')),
    width: 490,
    height: 170
  },
  {
    id: 'hinh-3.29',
    dataUrl: getImgDataUrl(path.join(__dirname, 'hinh_ve_sgk/hinh_3_29.png')),
    width: 370,
    height: 185
  },
  {
    id: 'hinh-3.30',
    dataUrl: getImgDataUrl(path.join(__dirname, 'hinh_ve_sgk/hinh_3_30.png')),
    width: 370,
    height: 193
  },
  {
    id: 'hinh-3.31',
    dataUrl: getImgDataUrl(path.join(__dirname, 'hinh_ve_sgk/hinh_3_31.png')),
    width: 400,
    height: 200
  },
  {
    id: 'hinh-3.32',
    dataUrl: getImgDataUrl(path.join(__dirname, 'hinh_ve_sgk/hinh_3_32.png')),
    width: 400,
    height: 192
  },
  {
    id: 'hinh-3.33',
    dataUrl: getImgDataUrl(path.join(__dirname, 'hinh_ve_sgk/hinh_3_33.png')),
    width: 380,
    height: 182
  },
  {
    id: 'hinh-3.34',
    dataUrl: getImgDataUrl(path.join(__dirname, 'hinh_ve_sgk/hinh_3_34.png')),
    width: 490,
    height: 163
  },
  {
    id: 'hinh-3.35',
    dataUrl: getImgDataUrl(path.join(__dirname, 'hinh_ve_sgk/hinh_3_35.png')),
    width: 370,
    height: 177
  },
  {
    id: 'hinh-3.36',
    dataUrl: getImgDataUrl(path.join(__dirname, 'hinh_ve_sgk/hinh_3_36.png')),
    width: 490,
    height: 156
  }
];
...
const mdPath = path.join(__dirname, 'KHBD_Toan8_Bai12_HinhBinhHanh.md');
...
const lessonInfo = {
  ...
  topic: 'Bài 12: Hình bình hành',
  lessonScope: 'Tiết 5, 6 (Tuần 3)',
...
const doc = new Document({
  ...
  title: 'KHBD_Toan8_Bai12_HinhBinhHanh',
  description: 'Kế hoạch bài dạy chuẩn Công văn 5512 - Bài 12: Hình bình hành (02 tiết - 90 phút) kèm 11 hình vẽ vector chuẩn SGK',
  styles: {
    default: {
      document: {
...
Packer.toBuffer(doc).then(buffer => {
  const outputPath = path.join(__dirname, 'KHBD_Toan8_Bai12_HinhBinhHanh.docx');
