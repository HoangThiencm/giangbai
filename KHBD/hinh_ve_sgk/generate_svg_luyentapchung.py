...
svg_hinh_3_25 = """<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 440 220" width="440" height="220">
  ...
  <defs>
    <style>
      ...
      .point-dot { fill: #111827; }
      .label-vertex { font-family: 'Times New Roman', serif; font-style: italic; font-size: 18px; font-weight: bold; fill: #111827; }
      .label-deg { font-family: 'Times New Roman', serif; font-size: 15px; font-weight: bold; fill: #111827; }
      .angle-arc { stroke: #111827; stroke-width: 1.5; fill: none; }
    </style>
  </defs>
...
svg_hinh_3_26 = """<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 230" width="500" height="230">
  ...
  <defs>
    <style>
      ...
      .point-dot { fill: #111827; }
      .label-vertex { font-family: 'Times New Roman', serif; font-style: italic; font-size: 18px; font-weight: bold; fill: #111827; }
      .label-deg { font-family: 'Times New Roman', serif; font-size: 14px; font-weight: bold; fill: #111827; }
      .angle-arc { stroke: #111827; stroke-width: 1.5; fill: none; }
      .tick-mark { stroke: #111827; stroke-width: 1.8; stroke-linecap: round; }
    </style>
  </defs>
